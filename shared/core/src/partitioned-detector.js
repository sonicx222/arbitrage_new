...
class PartitionedDetector extends events_1.EventEmitter {
    constructor(config, deps) {
        ...
        this.logger = deps?.logger ?? (0, logger_1.createLogger)(`partition:${config.partitionId}`);
        this.perfLogger = deps?.perfLogger ?? (0, logger_1.getPerformanceLogger)(`partition:${config.partitionId}`);
        this.normalizeToken = deps?.normalizeToken ?? src_1.normalizeTokenForCrossChain;

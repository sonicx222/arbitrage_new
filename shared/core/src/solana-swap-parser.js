...
exports.SolanaSwapParser = exports.DISABLED_DEXES = exports.SWAP_DISCRIMINATORS = exports.PROGRAM_ID_TO_DEX = exports.SOLANA_DEX_PROGRAM_IDS = void 0;
exports.getSolanaSwapParser = getSolanaSwapParser;
exports.resetSolanaSwapParser = resetSolanaSwapParser;
const events_1 = require("events");
const logger_1 = require("./logger");
const logger = (0, logger_1.createLogger)('solana-swap-parser');
// =============================================================================
// Constants
// =============================================================================
/**
 ...
 */
exports.SOLANA_DEX_PROGRAM_IDS = {
 ...
 */
exports.PROGRAM_ID_TO_DEX = {
    [exports.SOLANA_DEX_PROGRAM_IDS.JUPITER]: 'jupiter',
    [exports.SOLANA_DEX_PROGRAM_IDS.RAYDIUM_AMM]: 'raydium',
    [exports.SOLANA_DEX_PROGRAM_IDS.RAYDIUM_CLMM]: 'raydium-clmm',
    [exports.SOLANA_DEX_PROGRAM_IDS.ORCA_WHIRLPOOL]: 'orca',
    [exports.SOLANA_DEX_PROGRAM_IDS.METEORA_DLMM]: 'meteora',
    [exports.SOLANA_DEX_PROGRAM_IDS.PHOENIX]: 'phoenix',
    [exports.SOLANA_DEX_PROGRAM_IDS.LIFINITY]: 'lifinity'
};
/**
 ...
 */
exports.DISABLED_DEXES = new Set(['jupiter']);
// =============================================================================
 ...
 */
class SolanaSwapParser extends events_1.EventEmitter {
    constructor(config = {}) {
        super();
     ...
     */
    getAccountPubkey(accounts, index) {
    ...
    getDexFromProgramId(programId) {
        return exports.PROGRAM_ID_TO_DEX[programId] ?? null;
    }
    /**
     * Check if a DEX is enabled for parsing.
     */
    isDexEnabled(dex) {
        return this.config.enabledDexes.includes(dex) && !exports.DISABLED_DEXES.has(dex);
    }
    /**
     * Check if program ID belongs to a known DEX.
     */
    isKnownDexProgram(programId) {
        return programId in exports.PROGRAM_ID_TO_DEX;
    }
    // ===========================================================================
    ...
    isRaydiumAmmSwap(instruction) {
        if (instruction.data.length < 1)
            return false;
        // Raydium AMM v4: instruction index 9 = swap
        return instruction.data[0] === exports.SWAP_DISCRIMINATORS.RAYDIUM_AMM_SWAP;
    }
    isRaydiumClmmSwap(instruction) {
        if (instruction.data.length < 8)
            return false;
        // Check Anchor discriminator
        return instruction.data.slice(0, 8).equals(exports.SWAP_DISCRIMINATORS.RAYDIUM_CLMM_SWAP);
    }
    isOrcaWhirlpoolSwap(instruction) {
        if (instruction.data.length < 8)
            return false;
        // Check Anchor discriminator
        return instruction.data.slice(0, 8).equals(exports.SWAP_DISCRIMINATORS.ORCA_WHIRLPOOL_SWAP);
    }
    isMeteoraDlmmSwap(instruction) {
        if (instruction.data.length < 8)
            return false;
        // Check Anchor discriminator
        return instruction.data.slice(0, 8).equals(exports.SWAP_DISCRIMINATORS.METEORA_DLMM_SWAP);
    }
    isPhoenixTrade(instruction) {
        if (instruction.data.length < 8)
            return false;
        // Phoenix V1: Check Anchor discriminator for Swap instruction
        return instruction.data.slice(0, 8).equals(exports.SWAP_DISCRIMINATORS.PHOENIX_SWAP);
    }
    isLifinitySwap(instruction) {
        if (instruction.data.length < 8)
            return false;
        // Check Anchor discriminator
        return instruction.data.slice(0, 8).equals(exports.SWAP_DISCRIMINATORS.LIFINITY_SWAP);
    }
    // ===========================================================================
    // Transaction Parsing
    // ===========================================================================
     ...
     */
    parseRaydiumAmmSwap(instruction, context) {
        try {
     ...
     */
    parseRaydiumClmmSwap(instruction, context) {
        try {
     ...
     */
    parseOrcaWhirlpoolSwap(instruction, context) {
        try {
     ...
     */
    parseMeteoraDlmmSwap(instruction, context) {
        try {
     ...
     */
    parsePhoenixTrade(instruction, context) {
        try {
     ...
     */
    parseLifinitySwap(instruction, context) {
        try {
...
exports.SolanaSwapParser = SolanaSwapParser;
// =============================================================================
// Singleton Factory
// =============================================================================
 ...
 */
function getSolanaSwapParser(config) {
    if (!parserInstance) {
        parserInstance = new SolanaSwapParser(config);
    }
    else if (config && Object.keys(config).length > 0) {
        // Warn if config is provided but instance already exists
        logger.warn('SolanaSwapParser already initialized, config ignored. Use updateConfig() to modify.', { providedConfig: config });
    }
 ...
 */
function resetSolanaSwapParser() {
    parserInstance = null;
}
exports.default = SolanaSwapParser;
//# sourceMappingURL=solana-swap-parser.js.map
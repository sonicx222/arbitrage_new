...
export class RedisStreamsClient {
  ...
  static readonly STREAM_MAX_LENGTH_DEFAULTS: Record<string, number> = {
    ...
    [RedisStreamsClient.STREAMS.VOLUME_AGGREGATES]: 50000, // RT-013 FIX: Increased from 10K — was at 100% capacity and actively trimming
  ...
  constructor(url: string, password?: string, deps?: RedisStreamsClientDeps) {
    ...
    const options: Record<string, unknown> = {
      ...
      // operations until manual restart.

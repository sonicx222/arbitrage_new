...
import { getSelfHealingManager } from './resilience/self-healing-manager';
...
export class EnterpriseTestingFramework {
  ...
  async runPerformanceRegression(
    ...
    const regressions: Array<{ metric: string; baseline: number; current: number; change: number; significant: boolean }> = [];

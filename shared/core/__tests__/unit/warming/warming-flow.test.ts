/**
 * Warming Flow Unit Tests
 *
 * Tests for warming workflow with L1-only cache (no Redis L2).
 * Reclassified from integration: runs pure in-memory with no external dependencies.
 *
...
describe('Warming Flow Unit Tests', () => {

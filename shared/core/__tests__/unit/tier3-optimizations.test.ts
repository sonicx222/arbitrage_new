 ...
 * (T3.15 Liquidity Depth Analysis moved to dedicated liquidity-depth-analyzer.test.ts)
 *
...
// T3.15: Liquidity Depth Analysis tests removed — fully covered by
// shared/core/__tests__/unit/liquidity-depth-analyzer.test.ts (1861 lines,
// including V3 concentrated liquidity, Curve StableSwap, multi-tick traversal)

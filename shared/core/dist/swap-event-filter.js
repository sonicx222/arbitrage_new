...
exports.SwapEventFilter = void 0;
exports.getSwapEventFilter = getSwapEventFilter;
exports.resetSwapEventFilter = resetSwapEventFilter;
const logger_1 = require("./logger");
const logger = (0, logger_1.createLogger)('swap-event-filter');
// =============================================================================
// Swap Event Filter
// =============================================================================
class SwapEventFilter {
    constructor(config = {}) {
        ...
        this.aggregationBuckets = new Map(); // pairAddress -> bucket
        this.aggregationTimer = null;
        this.cleanupTimer = null;
        this.destroyed = false; // Guard against use after destroy
        // Statistics
        this.stats = {
            totalProcessed: 0,
            totalPassed: 0,
    ...
    createFilteredResult(event, reason, startTime) {
    ...
    // Volume Aggregation
    // ===========================================================================
    addToAggregationBucket(event, usdValue) {
...
exports.SwapEventFilter = SwapEventFilter;
// =============================================================================
// Singleton Factory
// =============================================================================
let filterInstance = null;
let initializingFilter = false; // Race condition guard
function getSwapEventFilter(config) {
...
//# sourceMappingURL=swap-event-filter.js.map
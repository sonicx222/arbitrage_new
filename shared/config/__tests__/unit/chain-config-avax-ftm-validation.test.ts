...
describe('PairDiscoveryService Chain Integration', () => {
  let PairDiscoveryService: typeof import('@arbitrage/core').PairDiscoveryService;
  let resetPairDiscoveryService: typeof import('@arbitrage/core').resetPairDiscoveryService;

...
let isolatedModule: {
  createMempoolDetectorService: typeof import('../../src/index').createMempoolDetectorService;
  MempoolDetectorService: typeof import('../../src/index').MempoolDetectorService;
  DEFAULT_CONFIG: typeof import('../../src/index').DEFAULT_CONFIG;
} | null = null;
...
const loadServiceWithMocks = async () => {
  ...
  await jest.isolateModulesAsync(async () => {
    ...
    // Mock bloxroute-feed
    jest.doMock('../../src/bloxroute-feed', () => {

...
export abstract class BaseExecutionStrategy {
  ...
  protected decodeContractError(
    ...
    if (
      ...
      // P3-FIX 4.1 / Phase 5.3: Use auto-generated error selectors from ABI
      // Generated by: npm run generate:error-selectors
      // Source: contracts/artifacts/src/FlashLoanArbitrage.sol/FlashLoanArbitrage.json
      //
      // NOTE: After modifying FlashLoanArbitrage.sol errors, regenerate with:

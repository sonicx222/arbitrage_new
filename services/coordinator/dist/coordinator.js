...
class CoordinatorService {
    redis = null;
    streamsClient = null;
    logger = (0, src_1.createLogger)('coordinator');
    perfLogger;
    stateManager;
    app;
    server = null;
    isRunning = false; // Kept for backwards compat, derived from stateManager
    isLeader = false;
    ...
    OPPORTUNITY_TTL_MS = 60000; // 1 minute default TTL

...
export declare class ArbitrageError extends Error {
    ...
    recoverable: boolean;
    constructor(code: string, message: string, details?: any | undefined, recoverable?: boolean);
}
export declare class ExecutionError extends ArbitrageError {
    opportunityId: string;
    constructor(code: string, message: string, opportunityId: string, details?: any);
}
export declare class ConfigurationError extends Error {
    key: string;
    defaultValue?: any | undefined;
    constructor(key: string, message: string, defaultValue?: any | undefined);
}

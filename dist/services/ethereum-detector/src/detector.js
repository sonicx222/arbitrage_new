...
exports.EthereumDetectorService = void 0;
// Ethereum DEX Detector Service
const ethers_1 = require("ethers");
const ws_1 = __importDefault(require("ws"));
const src_1 = require("../../../shared/core/src");
const src_2 = require("../../../shared/config/src");
class EthereumDetectorService {
    constructor() {
        this.wsProvider = null;
        this.redis = (0, src_1.getRedisClient)();
        this.logger = (0, src_1.createLogger)('ethereum-detector');
        this.pairs = new Map(); // pairKey -> pair data
        this.monitoredPairs = new Set();
        this.isRunning = false;
        this.perfLogger = (0, src_1.getPerformanceLogger)('ethereum-detector');
        this.dexes = src_2.DEXES.ethereum;
        this.tokens = src_2.CORE_TOKENS.ethereum;
        this.provider = new ethers_1.ethers.JsonRpcProvider(src_2.CHAINS.ethereum.rpcUrl);
    }
    async start() {
        try {
    ...
    async connectWebSocket() {
        return new Promise((resolve, reject) => {
            try {
                const wsUrl = src_2.CHAINS.ethereum.wsUrl;
    ...
    async checkWhaleActivity(swapEvent) {
        if (!swapEvent.usdValue || swapEvent.usdValue < 100000)
            return; // $100K threshold for Ethereum (higher due to gas costs)
...
exports.EthereumDetectorService = EthereumDetectorService;
